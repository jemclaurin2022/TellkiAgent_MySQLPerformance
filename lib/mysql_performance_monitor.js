...
metrics["Com_delete"] =  {id:"43:Delete statements/Sec:7",ratio:true};
metrics["Com_insert"] =  {id:"192:Insert statements/Sec:7",ratio:true};
metrics["Com_select"] =  {id:"41:Select statements/Sec:7",ratio:true};
metrics["Com_update"] =  {id:"162:Update statements/Sec:7",ratio:true};
metrics["Connections"] =  {id:"93:Connections/Sec:7",ratio:true};	
metrics["Created_tmp_disk_tables"] = {id:"193:Temporary tables on disk/Sec:7",ratio:true};
metrics["Handler_read_first"] = {id:"210:Handler read first/Sec:7",ratio:true};
metrics["Innodb_buffer_pool_read_requests"] =  {id:"100:Buffer pool read requests/Sec (Innodb):7",ratio:true};
metrics["Innodb_buffer_pool_wait_free"] =  {id:"185:Buffer pool wait free (Innodb):7",ratio:false};
metrics["Innodb_data_pending_reads"] =  {id:"131:Data reads pending (Innodb):7",ratio:false};
metrics["Innodb_rows_read"] =  {id:"21:Innodb rows read/Sec:7",ratio:true};
metrics["Key_reads"] =  {id:"144:Key reads/Sec:7",ratio:true};
metrics["Max_used_connections"] =  {id:"212:Max used connections:7",ratio:false};
metrics["Open_tables"] =  {id:"62:Open tables:7",ratio:false};
metrics["Qcache_hits"] =  {id:"190:Qcache hits/Sec:7",ratio:true};
metrics["Qcache_queries_in_cache"] = {id:"88:Queries in cache:7",ratio:false};
metrics["Questions"] = {id:"176:Questions/Sec:7",ratio:true};
metrics["Select_full_join"] = {id:"49:Full joins/Sec:7",ratio:true};
metrics["Slow_queries"] = {id:"145:Slow queries/Sec:7",ratio:true};
metrics["Table_locks_waited"] = {id:"172:Table locks waited/Sec:7",ratio:true};
metrics["Threads_connected"] = {id:"3:Threads connected:7",ratio:false};
metrics["Threads_running"] =  {id:"170:Threads running:7",ratio:false};
metrics["Uptime"] = {id:"80:Uptime:7",ratio:false}; 
